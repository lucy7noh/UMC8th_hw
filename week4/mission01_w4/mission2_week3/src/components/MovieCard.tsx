...
export default function MovieCard({ movie }: MovieCardProps): Element {
  ...
  return (
    ...
    onClick={(): void | Promise<void> => navigate(`/movie/${movie.id}`)}
      className="relative rounded-xl shadow-lg overflow-hidden cursor-poninter w-44 
    ...
    >
      ...
      {isHovered && (
        ...
        bg-gradient-to-t from-black/50 to-transparent backdrop-blur-md flex 
        flex-col justify-center item-center  text-white p-4'>
